...
<h1 style="margin:0 0 16px;font-size:22px;line-height:1.3;font-weight:700;color:#1f2937;">
	<?= esc_html__('New form submission', 'baselayer-forms') ?>
</h1>
<p style="margin:0 0 16px;font-size:15px;line-height:1.5;color:#1f2937;">
	<?= esc_html(sprintf(
		/* translators: 1: form title, 2: site name */
		__('A new submission was received for “%1$s” on %2$s.', 'baselayer-forms'),
		(string) ($form_title ?? ''),
		(string) ($site_name ?? '')
	)) ?>
</p>
...
<p style="margin:0;font-size:13px;line-height:1.5;color:#64748b;">
	<?= esc_html(sprintf(__('Entry ID: %d', 'baselayer-forms'), (int) ($entry_id ?? 0))) ?>
</p>
