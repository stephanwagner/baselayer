...
function fs_icon_labels(): array
{
	return [
		...
		'attachment-alt'         => _x('Attachment (alt)', 'icon name', 'fromscratch-icons'),
		...
		'lists'                  => _x('Lists', 'icon name', 'fromscratch-icons'),
		...
		'arrow-height'           => _x('Line height', 'icon name', 'fromscratch-icons'),
		...
		'devices-fold'           => _x('Foldable device', 'icon name', 'fromscratch-icons'),
		'devices-wearables'      => _x('Wearables', 'icon name', 'fromscratch-icons'),
		...
		'puzzle-alt'             => _x('Puzzle (alt)', 'icon name', 'fromscratch-icons'),
		...
		'arrow-downwards'        => _x('Arrow downwards', 'icon name', 'fromscratch-icons'),
		...
		'family-star'            => _x('Family star', 'icon name', 'fromscratch-icons'),
		...
		'sparts-flag'            => _x('Sports flag', 'icon name', 'fromscratch-icons'),
		...
		'tooltip-alt'            => _x('Tooltip (alt)', 'icon name', 'fromscratch-icons'),
		'tv-remote'              => _x('TV remote', 'icon name', 'fromscratch-icons'),
		'two-wheeler'            => _x('Two-wheeler', 'icon name', 'fromscratch-icons'),
