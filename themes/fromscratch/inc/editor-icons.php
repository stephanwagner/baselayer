...
function fs_icon_labels(): array
{
	return [
		...
		'arrow-up-right'         => _x('Arrow outward', 'icon name', 'fromscratch-icons'),
		'arrow-range'            => _x('Arrow range', 'icon name', 'fromscratch-icons'),
		'arrow-split'            => _x('Arrow split', 'icon name', 'fromscratch-icons'),
		'arrow-split-up'         => _x('Arrow split up', 'icon name', 'fromscratch-icons'),
		...
		'arrows-input'           => _x('Arrows input', 'icon name', 'fromscratch-icons'),
		'arrows-output'          => _x('Arrows output', 'icon name', 'fromscratch-icons'),
		...
		'arrow-left-alt'         => _x('Arrow left', 'icon name', 'fromscratch-icons'),
		'arrow-right-alt'        => _x('Arrow right', 'icon name', 'fromscratch-icons'),
		'arrow-up-alt'           => _x('Arrow up', 'icon name', 'fromscratch-icons'),
		...
		'arrow-down-alt'         => _x('Arrow down', 'icon name', 'fromscratch-icons'),
		...
		'move-selection-up'      => _x('Move selection up', 'icon name', 'fromscratch-icons'),
		'move-selection-down'    => _x('Move selection down', 'icon name', 'fromscratch-icons'),
		'move-selection-left'    => _x('Move selection left', 'icon name', 'fromscratch-icons'),
		'move-selection-right'   => _x('Move selection right', 'icon name', 'fromscratch-icons'),
		...
		'download-alt'           => _x('Download', 'icon name', 'fromscratch-icons'),
		'upload'                 => _x('Upload', 'icon name', 'fromscratch-icons'),
		'upload-alt'             => _x('Upload', 'icon name', 'fromscratch-icons'),
		...
		'attachment-alt'         => _x('Attachment', 'icon name', 'fromscratch-icons'),
		'search'                 => _x('Search', 'icon name', 'fromscratch-icons'),
		'select'                 => _x('Select', 'icon name', 'fromscratch-icons'),
		'select-all'             => _x('Select all', 'icon name', 'fromscratch-icons'),
		...
		'text-snippet'           => _x('Text snippet', 'icon name', 'fromscratch-icons'),
		...
		'symbol-sum'             => _x('Sum symbol', 'icon name', 'fromscratch-icons'),
		'asterix'                => _x('Asterisk', 'icon name', 'fromscratch-icons'),
		...
		'bold'                    => _x('Bold', 'icon name', 'fromscratch-icons'),
		'italic'                  => _x('Italic', 'icon name', 'fromscratch-icons'),
		'underlined'              => _x('Underline', 'icon name', 'fromscratch-icons'),
		'strikethrough'           => _x('Strikethrough', 'icon name', 'fromscratch-icons'),
		'align-left'              => _x('Align left', 'icon name', 'fromscratch-icons'),
		'align-center'            => _x('Align center', 'icon name', 'fromscratch-icons'),
		'align-right'             => _x('Align right', 'icon name', 'fromscratch-icons'),
		'align-justify'           => _x('Justify', 'icon name', 'fromscratch-icons'),
		'align-horizontal-left'   => _x('Align horizontal left', 'icon name', 'fromscratch-icons'),
		'align-horizontal-center' => _x('Align horizontal center', 'icon name', 'fromscratch-icons'),
		'align-horizontal-right'  => _x('Align horizontal right', 'icon name', 'fromscratch-icons'),
		'horizontal-align-left'   => _x('Horizontal align left', 'icon name', 'fromscratch-icons'),
		...
		'checklist-rtl'           => _x('Checklist (RTL)', 'icon name', 'fromscratch-icons'),
		'list-alt'                => _x('List', 'icon name', 'fromscratch-icons'),
		'list'                    => _x('List', 'icon name', 'fromscratch-icons'),
		'indent-decrease'         => _x('Decrease indent', 'icon name', 'fromscratch-icons'),
		'indent-increase'         => _x('Increase indent', 'icon name', 'fromscratch-icons'),
		'line-spacing'            => _x('Line spacing', 'icon name', 'fromscratch-icons'),
		'arrow-up-down'           => _x('Arrow up down', 'icon name', 'fromscratch-icons'),
		'letter-spacing'          => _x('Letter spacing', 'icon name', 'fromscratch-icons'),
		'format-size'             => _x('Font size', 'icon name', 'fromscratch-icons'),
		'text-decrease'           => _x('Decrease text size', 'icon name', 'fromscratch-icons'),
		'text-increase'           => _x('Increase text size', 'icon name', 'fromscratch-icons'),
		'text-short'              => _x('Short text', 'icon name', 'fromscratch-icons'),
		'color-text'              => _x('Text color', 'icon name', 'fromscratch-icons'),
		'color-fill'              => _x('Highlight color', 'icon name', 'fromscratch-icons'),
		'highlight'               => _x('Highlight', 'icon name', 'fromscratch-icons'),
		'border-color'            => _x('Border color', 'icon name', 'fromscratch-icons'),
		'color-reset'             => _x('Clear formatting', 'icon name', 'fromscratch-icons'),
		'format-clear'            => _x('Clear format', 'icon name', 'fromscratch-icons'),
		...
		'table-chart'             => _x('Table chart', 'icon name', 'fromscratch-icons'),
		'table-edit'              => _x('Edit table', 'icon name', 'fromscratch-icons'),
		'combine-columns'         => _x('Combine columns', 'icon name', 'fromscratch-icons'),
		'combine-rows'            => _x('Combine rows', 'icon name', 'fromscratch-icons'),
		'add-column-left'         => _x('Add column left', 'icon name', 'fromscratch-icons'),
		'add-column-right'        => _x('Add column right', 'icon name', 'fromscratch-icons'),
		'add-row-above'           => _x('Add row above', 'icon name', 'fromscratch-icons'),
		'add-row-below'           => _x('Add row below', 'icon name', 'fromscratch-icons'),
		...
		'comic-bubble'           => _x('Comic bubble', 'icon name', 'fromscratch-icons'),
		'mail'                   => _x('Email', 'icon name', 'fromscratch-icons'),
		'inbox'                  => _x('Inbox', 'icon name', 'fromscratch-icons'),
		'inbox-text'             => _x('Inbox text', 'icon name', 'fromscratch-icons'),
		'email-open'             => _x('Open email', 'icon name', 'fromscratch-icons'),
		'at-character'           => _x('At character', 'icon name', 'fromscratch-icons'),
		'email-stacked'          => _x('Stacked email', 'icon name', 'fromscratch-icons'),
		'email-unread'           => _x('Unread email', 'icon name', 'fromscratch-icons'),
		'phone'                  => _x('Phone', 'icon name', 'fromscratch-icons'),
		'voicemail'              => _x('Voicemail', 'icon name', 'fromscratch-icons'),
		...
		'flag-waving'            => _x('Flag', 'icon name', 'fromscratch-icons'),
		...
		'image-left'             => _x('Image left', 'icon name', 'fromscratch-icons'),
		'image-right'            => _x('Image right', 'icon name', 'fromscratch-icons'),
		...
		'split-scene-top'        => _x('Split scene top', 'icon name', 'fromscratch-icons'),
		'pan-zoom'               => _x('Pan zoom', 'icon name', 'fromscratch-icons'),
		'pinch-zoom-in'          => _x('Pinch zoom in', 'icon name', 'fromscratch-icons'),
		'pinch-zoom-out'         => _x('Pinch zoom out', 'icon name', 'fromscratch-icons'),
		...
		'folder-stacked'         => _x('Copy folder', 'icon name', 'fromscratch-icons'),

		// Analytics & data.
		'chart-pie'              => _x('Pie chart', 'icon name', 'fromscratch-icons'),
		'chart-bar'              => _x('Bar chart', 'icon name', 'fromscratch-icons'),
		'chart-bar-alt'          => _x('Bar chart', 'icon name', 'fromscratch-icons'),
		'chart-line-bar'         => _x('Chart line bar', 'icon name', 'fromscratch-icons'),
		'chart-data'             => _x('Data chart', 'icon name', 'fromscratch-icons'),
		'chart-stacked'          => _x('Stacked chart', 'icon name', 'fromscratch-icons'),
		...
		'dashboard-alt'          => _x('Dashboard', 'icon name', 'fromscratch-icons'),
		...
		'chart-line-alt'         => _x('Line chart', 'icon name', 'fromscratch-icons'),
		...
		'wallet-alt'             => _x('Wallet', 'icon name', 'fromscratch-icons'),
		...
		'license-off'            => _x('Unlicensed', 'icon name', 'fromscratch-icons'),
		...
		'apple-pay'              => _x('Apple Pay', 'icon name', 'fromscratch-icons'),
		'googlepay'              => _x('Google Pay', 'icon name', 'fromscratch-icons'),
		'klarna'                 => _x('Klarna', 'icon name', 'fromscratch-icons'),

		// People & accounts.
		'account-circle'         => _x('Account circle', 'icon name', 'fromscratch-icons'),
		...
		'face-male'              => _x('Face male', 'icon name', 'fromscratch-icons'),
		...
		'wheelchair'             => _x('Wheelchair', 'icon name', 'fromscratch-icons'),
		...
		'map-pin'                => _x('Location', 'icon name', 'fromscratch-icons'),
		'location'               => _x('Locate', 'icon name', 'fromscratch-icons'),
		'location-off'           => _x('Locate off', 'icon name', 'fromscratch-icons'),
		'pin'                    => _x('Pin', 'icon name', 'fromscratch-icons'),
		'map-pin-drop'           => _x('Pin', 'icon name', 'fromscratch-icons'),
		'map-pin-circle'         => _x('Pin circle', 'icon name', 'fromscratch-icons'),
		'pin-off'                => _x('Pin off', 'icon name', 'fromscratch-icons'),
		'map-pin-add'            => _x('Add location', 'icon name', 'fromscratch-icons'),
		'map-pin-heart'          => _x('Location heart', 'icon name', 'fromscratch-icons'),
		...
		'navigation-rotated'     => _x('My location', 'icon name', 'fromscratch-icons'),
		'my-location'            => _x('My location', 'icon name', 'fromscratch-icons'),
		...
		'moped'                  => _x('Moped', 'icon name', 'fromscratch-icons'),
		'car'                    => _x('Car', 'icon name', 'fromscratch-icons'),
		'parking'                => _x('Parking', 'icon name', 'fromscratch-icons'),
		'traffic-light'          => _x('Traffic light', 'icon name', 'fromscratch-icons'),
		...
		'hotel'                  => _x('Hotel', 'icon name', 'fromscratch-icons'),

		// Devices & interaction.
		'devices'                => _x('Devices', 'icon name', 'fromscratch-icons'),
		'device-fold'            => _x('Foldable device', 'icon name', 'fromscratch-icons'),
		'wearables'              => _x('Wearables', 'icon name', 'fromscratch-icons'),
		'mobile'                 => _x('Mobile', 'icon name', 'fromscratch-icons'),
		'mobile-alt'             => _x('Mobile', 'icon name', 'fromscratch-icons'),
		'mobile-rotate'          => _x('Rotate mobile', 'icon name', 'fromscratch-icons'),
		'tablet'                 => _x('Tablet', 'icon name', 'fromscratch-icons'),
		...
		'radio'                  => _x('Radio', 'icon name', 'fromscratch-icons'),
		'laptop'                 => _x('Laptop', 'icon name', 'fromscratch-icons'),
		'laptop-alt'             => _x('Laptop', 'icon name', 'fromscratch-icons'),
		...
		'click-circles'          => _x('Click', 'icon name', 'fromscratch-icons'),
		...
		'qr-code-alt'            => _x('QR code', 'icon name', 'fromscratch-icons'),
		...
		'vr-headset'             => _x('VR headset', 'icon name', 'fromscratch-icons'),
		'headset'                => _x('Headset', 'icon name', 'fromscratch-icons'),
		'wifi'                   => _x('Wi‑Fi', 'icon name', 'fromscratch-icons'),
		'wifi-off'               => _x('Wi‑Fi off', 'icon name', 'fromscratch-icons'),
		...
		'tune-alt'               => _x('Tune', 'icon name', 'fromscratch-icons'),
		'wrench'                 => _x('Wrench', 'icon name', 'fromscratch-icons'),
		...
		'filter-alt'             => _x('Filter', 'icon name', 'fromscratch-icons'),
		'filter-alt-off'         => _x('Filter off', 'icon name', 'fromscratch-icons'),
		...
		'info-alt'                 => _x('Info', 'icon name', 'fromscratch-icons'),
		...
		'clock-alt'                => _x('Clock', 'icon name', 'fromscratch-icons'),
		'watch'                    => _x('Watch', 'icon name', 'fromscratch-icons'),
		'watch-text'               => _x('Watch', 'icon name', 'fromscratch-icons'),
		...
		'partly-cloudy-night'      => _x('Partly cloudy night', 'icon name', 'fromscratch-icons'),
		...
		'thermometer-alt'          => _x('Thermometer', 'icon name', 'fromscratch-icons'),
		'foggy'                    => _x('Foggy', 'icon name', 'fromscratch-icons'),
		'wind'                     => _x('Wind', 'icon name', 'fromscratch-icons'),
		'fan'                      => _x('Fan', 'icon name', 'fromscratch-icons'),
		...
		'glass-full'               => _x('Water glass', 'icon name', 'fromscratch-icons'),
		...
		// Sports & fitness.
		'game-controller'          => _x('Game controller', 'icon name', 'fromscratch-icons'),
		...
		'badminton'                => _x('Badminton', 'icon name', 'fromscratch-icons'),
		...
		'rugby'                    => _x('Rugby', 'icon name', 'fromscratch-icons'),
		...
		'flower-tulip'           => _x('Flower', 'icon name', 'fromscratch-icons'),
		...
		'wand-shine'             => _x('Magic wand shine', 'icon name', 'fromscratch-icons'),
		'wand-stars'             => _x('Magic wand', 'icon name', 'fromscratch-icons'),
		'palette'                => _x('Palette', 'icon name', 'fromscratch-icons'),
		'paintbrush'             => _x('Paintbrush', 'icon name', 'fromscratch-icons'),
		'paintbrush-off'         => _x('Paintbrush off', 'icon name', 'fromscratch-icons'),
		...
		'theater'                   => _x('Theater', 'icon name', 'fromscratch-icons'),
		...
		'cogwheels'              => _x('Cogwheels', 'icon name', 'fromscratch-icons'),
		'engineering'            => _x('Engineering', 'icon name', 'fromscratch-icons'),
		'box'                    => _x('Box', 'icon name', 'fromscratch-icons'),
		...
		'extensions'             => _x('Extensions', 'icon name', 'fromscratch-icons'),
		'puzzle'                 => _x('Puzzle', 'icon name', 'fromscratch-icons'),

		'chess'                  => _x('Chess', 'icon name', 'fromscratch-icons'),
		'toy'                    => _x('Toy', 'icon name', 'fromscratch-icons'),
		...
		'glasses'                => _x('Glasses', 'icon name', 'fromscratch-icons'),
		'suitcase'               => _x('Suitcase', 'icon name', 'fromscratch-icons'),
		'ticket-alt'             => _x('Ticket', 'icon name', 'fromscratch-icons'),
		...
		'youtube-shorts'         => _x('YouTube Shorts', 'icon name', 'fromscratch-icons'),
		...
		'apple-music'            => _x('Apple Music', 'icon name', 'fromscratch-icons'),
		...
		'brand-family'           => _x('Brand family', 'icon name', 'fromscratch-icons'),
		...
		'theme-logo'             => _x('Logo', 'icon name', 'fromscratch-icons'),
		'agender'                => _x('Agender', 'icon name', 'fromscratch-icons'),
		'airlines'               => _x('Airlines', 'icon name', 'fromscratch-icons'),
		'arrow-down-right'       => _x('Arrow downwards', 'icon name', 'fromscratch-icons'),
		'arrow-menu-close'       => _x('Arrow menu close', 'icon name', 'fromscratch-icons'),
		'arrow-menu-open'        => _x('Arrow menu open', 'icon name', 'fromscratch-icons'),
		'arrows-outward'         => _x('Arrows outward', 'icon name', 'fromscratch-icons'),
		'bus'                    => _x('Bus', 'icon name', 'fromscratch-icons'),
		'compress'               => _x('Compress', 'icon name', 'fromscratch-icons'),
		'eco'                    => _x('Eco', 'icon name', 'fromscratch-icons'),
		'edit-off'               => _x('Edit off', 'icon name', 'fromscratch-icons'),
		'star-family'            => _x('Family star', 'icon name', 'fromscratch-icons'),
		'fast-forward'           => _x('Fast forward', 'icon name', 'fromscratch-icons'),
		'fast-rewind'            => _x('Fast rewind', 'icon name', 'fromscratch-icons'),
		'first-page'             => _x('First page', 'icon name', 'fromscratch-icons'),
		'fit-page'               => _x('Fit page', 'icon name', 'fromscratch-icons'),
		'folder-edit'            => _x('Folder edit', 'icon name', 'fromscratch-icons'),
		'grad-pan'               => _x('Pan', 'icon name', 'fromscratch-icons'),
		'groups'                 => _x('Groups', 'icon name', 'fromscratch-icons'),
		'last-page'              => _x('Last page', 'icon name', 'fromscratch-icons'),
		...
		'mobile-vibrate'         => _x('Mobile vibrate', 'icon name', 'fromscratch-icons'),
		'monitor-heart'          => _x('Monitor heart', 'icon name', 'fromscratch-icons'),
		'news-article'           => _x('News article', 'icon name', 'fromscratch-icons'),
		'note'                   => _x('Note', 'icon name', 'fromscratch-icons'),
		'note-stack'             => _x('Note stack', 'icon name', 'fromscratch-icons'),
		'odometer'               => _x('Odometer', 'icon name', 'fromscratch-icons'),
		'pause-circle'           => _x('Pause circle', 'icon name', 'fromscratch-icons'),
		'present'                => _x('Present', 'icon name', 'fromscratch-icons'),
		'repeat'                 => _x('Repeat', 'icon name', 'fromscratch-icons'),
		'replay'                 => _x('Replay', 'icon name', 'fromscratch-icons'),
		'scanner'                => _x('Scanner', 'icon name', 'fromscratch-icons'),
		'shuffle'                => _x('Shuffle', 'icon name', 'fromscratch-icons'),
		'sick'                   => _x('Sick', 'icon name', 'fromscratch-icons'),
		'slab-serif'             => _x('Slab serif', 'icon name', 'fromscratch-icons'),
		'smart-toy'              => _x('Smart toy', 'icon name', 'fromscratch-icons'),
		'toy-fan'                => _x('Toy fan', 'icon name', 'fromscratch-icons'),
		'sports-flag'            => _x('Sports flag', 'icon name', 'fromscratch-icons'),
		'special-character'      => _x('Special character', 'icon name', 'fromscratch-icons'),
		'step'                   => _x('Step', 'icon name', 'fromscratch-icons'),
		'stop-circle'            => _x('Stop circle', 'icon name', 'fromscratch-icons'),
		'strategy'               => _x('Strategy', 'icon name', 'fromscratch-icons'),
		'subtitles'              => _x('Subtitles', 'icon name', 'fromscratch-icons'),
		'switch-left'            => _x('Switch left', 'icon name', 'fromscratch-icons'),
		'switch-right'           => _x('Switch right', 'icon name', 'fromscratch-icons'),
		'swords'                 => _x('Swords', 'icon name', 'fromscratch-icons'),
		'syringe'                => _x('Syringe', 'icon name', 'fromscratch-icons'),
		'titlecase'              => _x('Title case', 'icon name', 'fromscratch-icons'),
		'tooltip-text'           => _x('Tooltip', 'icon name', 'fromscratch-icons'),
		'tooltip'            => _x('Tooltip', 'icon name', 'fromscratch-icons'),
		'tv-remote'              => _x('TV remote', 'icon name', 'fromscratch-icons'),
		'motorbike'            => _x('Motorbike', 'icon name', 'fromscratch-icons'),
		'vaccines'               => _x('Vaccines', 'icon name', 'fromscratch-icons'),
	];
}
...
function fs_icon_category_labels(): array
{
	return [
		...
		'theme'          => _x('Theme', 'icon category', 'fromscratch-icons'),
	];
}
