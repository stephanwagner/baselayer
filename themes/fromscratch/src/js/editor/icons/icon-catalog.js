...
const builtInCategories = [
  {
    ...
    icons: [
      ...
      { filename: 'arrow-height', alternatives: [], keywords: ['line', 'height', 'leading', 'vertical', 'spacing', 'arrow'] },
      ...
      { filename: 'arrow-downwards', alternatives: [], keywords: ['arrow', 'down', 'downward', 'direction'] },
  ...
  },
  {
    ...
    icons: [
      ...
      { filename: 'lists', alternatives: [], keywords: ['lists', 'toc', 'index', 'outline'] },
  ...
  },
  {
    ...
    icons: [
      ...
      { filename: 'family-star', alternatives: ['fill'], keywords: ['family', 'star', 'favorite', 'household', 'rating'] },
  ...
  },
  {
    ...
    icons: [
      ...
      { filename: 'two-wheeler', alternatives: ['fill'], keywords: ['scooter', 'moped', 'motorcycle', 'transport', 'bike'] },
    ],
  },
  {
    slug: 'devices',
    icons: [
      ...
      { filename: 'devices-fold', alternatives: ['fill'], keywords: ['devices', 'fold', 'foldable', 'phone', 'tablet'] },
      ...
      { filename: 'devices-wearables', alternatives: ['fill'], keywords: ['devices', 'wearables', 'watch', 'band', 'smartwatch'] },
  ...
  },
  {
    ...
    icons: [
      ...
      { filename: 'tooltip-alt', alternatives: ['fill'], keywords: ['tooltip', 'hint', 'help', 'info', 'popup', 'alt'] },
      { filename: 'tooltip', alternatives: ['fill'], keywords: ['tooltip', 'hint', 'help', 'info', 'popup'] },
    ],
  },
  {
    slug: 'weather',
  ...
  },
  {
    ...
    icons: [
      ...
      { filename: 'sparts-flag', alternatives: [], keywords: ['sports', 'flag', 'finish', 'race', 'goal'] },
  ...
  },
  {
    ...
    icons: [
      ...
      { filename: 'puzzle-alt', alternatives: ['fill'], keywords: ['puzzle', 'piece', 'extension', 'plugin', 'addon'] },
