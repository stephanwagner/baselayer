...
const builtInCategories = [
  {
    ...
    icons: [
      ...
      { filename: 'content-grid', alternatives: ['fill'], keywords: ['content', 'grid', 'catalog', 'library', 'layout', 'panels', 'browse', 'view'] },
    ],
  },
  {
    slug: 'actions',
    icons: [
      ...
      { filename: 'split', alternatives: [], keywords: ['split', 'divide', 'separate', 'columns'] },
  ...
  },
  {
    ...
    icons: [
      ...
      { filename: 'format-bold', alternatives: [], keywords: ['bold', 'strong', 'weight', 'typography'] },
      { filename: 'format-italic', alternatives: [], keywords: ['italic', 'emphasis', 'slant', 'typography'] },
      { filename: 'format-underlined', alternatives: [], keywords: ['underline', 'typography', 'text'] },
      { filename: 'format-strikethrough', alternatives: ['fill'], keywords: ['strikethrough', 'strike', 'cross out', 'typography'] },
      { filename: 'format-align-left', alternatives: [], keywords: ['align', 'left', 'text', 'paragraph'] },
      { filename: 'format-align-center', alternatives: [], keywords: ['align', 'center', 'text', 'paragraph'] },
      { filename: 'format-align-right', alternatives: [], keywords: ['align', 'right', 'text', 'paragraph'] },
      { filename: 'format-align-justify', alternatives: [], keywords: ['align', 'justify', 'text', 'paragraph'] },
      { filename: 'format-list-bulleted', alternatives: [], keywords: ['list', 'bulleted', 'unordered', 'ul', 'list-bullet'] },
      { filename: 'format-list-numbered', alternatives: [], keywords: ['list', 'numbered', 'ordered', 'ol', 'list-number'] },
      { filename: 'checklist', alternatives: [], keywords: ['checklist', 'todo', 'tasks', 'list'] },
      { filename: 'list', alternatives: [], keywords: ['lines', 'items', 'menu'] },
      { filename: 'format-indent-decrease', alternatives: [], keywords: ['indent', 'decrease', 'outdent', 'margin'] },
      { filename: 'format-indent-increase', alternatives: [], keywords: ['indent', 'increase', 'margin'] },
      { filename: 'format-line-spacing', alternatives: [], keywords: ['line', 'spacing', 'leading', 'paragraph'] },
      { filename: 'format-letter-spacing', alternatives: ['fill'], keywords: ['letter', 'spacing', 'tracking', 'typography'] },
      { filename: 'format-size', alternatives: ['fill'], keywords: ['font', 'size', 'text', 'typography'] },
      { filename: 'format-color-text', alternatives: [], keywords: ['text', 'color', 'font', 'typography'] },
      { filename: 'format-color-fill', alternatives: [], keywords: ['highlight', 'fill', 'background', 'color'] },
      { filename: 'border-color', alternatives: ['fill'], keywords: ['border', 'color', 'outline', 'pen'] },
      { filename: 'format-color-reset', alternatives: ['fill'], keywords: ['reset', 'clear', 'color', 'formatting'] },
      ...
      { filename: 'format-image-left', alternatives: ['fill'], keywords: ['align', 'wrap', 'float', 'text', 'image'] },
      { filename: 'format-image-right', alternatives: ['fill'], keywords: ['align', 'wrap', 'float', 'text', 'image'] },
      { filename: 'format-image-front', alternatives: ['fill'], keywords: ['align', 'inline', 'image', 'text', 'wrap'] },
  ...
  },
  {
    ...
    icons: [
      ...
      { filename: 'leaderboard', alternatives: ['fill'], keywords: ['leaderboard', 'ranking', 'score', 'top'] },
  ...
  },
  {
    ...
    icons: [
      ...
      { filename: 'power', alternatives: ['fill'], keywords: ['power', 'on', 'energy', 'electricity'] },
  ...
  },
  {
    ...
    icons: [
      ...
      { filename: 'watch-alt', alternatives: ['fill'], keywords: ['watch', 'time', 'wristwatch', 'schedule', 'wearable'] },
  ...
  },
  {
    ...
    icons: [
      ...
      { filename: 'bug', alternatives: ['fill'], keywords: ['bug', 'insect', 'debug', 'issue'] },
