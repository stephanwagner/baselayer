...
return [
	'presets' => [
		'content-margin' => [
			'label' => 'Abstand',
			'controls' => [
				fs_block_options_control_content_margin(''),
			],
		],
		'content-margin-m' => [
			'label' => 'Abstand (M)',
			'controls' => [
				fs_block_options_control_content_margin('m'),
			],
		],
		'content-padding-m' => [
			'label' => 'Innenabstand (M)',
			'controls' => [
				fs_block_options_control_content_padding('m'),
			],
		],
		'content-padding-l' => [
			'label' => 'Innenabstand (L)',
			'controls' => [
				fs_block_options_control_content_padding('l'),
			],
		],
		'content-padding-xl' => [
			'label' => 'Innenabstand (XL)',
			'controls' => [
				fs_block_options_control_content_padding('xl'),
			],
		],
		'limit-width' => [
			'label' => 'Weite limitieren',
			'controls' => [
				fs_block_options_control_limit_width(),
			],
		],
		'align-wide-container' => [
			'label' => 'Inhaltsbreite',
			'controls' => [
				fs_block_options_control_align_wide_container(),
			],
		],
		'text-wrap' => [
			'label' => 'Text Wrap',
			'controls' => [
				fs_block_options_control_text_wrap(),
			],
		],
		'spacer-responsive-height' => [
			'label' => 'Responsive Höhe',
			'controls' => [
				fs_block_options_control_spacer_responsive_height(),
			],
		],
		'columns-layout' => [
