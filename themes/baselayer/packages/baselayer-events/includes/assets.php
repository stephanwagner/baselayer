...
function bl_events_enqueue_editor_assets(): void
{
	...
	wp_localize_script('bl-events-editor', 'baselayerEvents', [
		...
		'moreActions' => __('More options', 'baselayer-events'),
		...
		'standaloneRestUrl' => esc_url_raw(rest_url('baselayer/v1/event-standalone/')),
...
function bl_events_enqueue_admin_list_assets(string $hook): void
{
	...
	wp_localize_script('bl-events-admin', 'baselayerEventOccurrences', [
		...
		'cancelLabel' => __('Cancel', 'baselayer-events'),
		'deleteConfirmTitle' => __('Delete occurrence', 'baselayer-events'),
		'deleteConfirm' => __('Remove this date from the series? It won\'t be moved to the trash. You can restore it here later.', 'baselayer-events'),
		'deleteCustomizedConfirm' => __('This occurrence has customized fields. Deleting removes those edits permanently. Continue?', 'baselayer-events'),
		'closeLabel' => __('Close', 'baselayer-events'),
		'loadingLabel' => __('Loading…', 'baselayer-events'),
		'customContent' => __('Customized', 'baselayer-events'),
		'standaloneLabel' => __('Standalone', 'baselayer-events'),
