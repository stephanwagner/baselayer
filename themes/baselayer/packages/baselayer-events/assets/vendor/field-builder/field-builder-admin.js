(() => {
  // themes/baselayer/src/js/admin/field-builder/registry.js
  var types = /* @__PURE__ */ new Map();
  function registerType(definition) {
  ...
  function listTypesForMode(mode = "fields") {
  ...
  // themes/baselayer/src/js/admin/field-builder/dom.js
  ...
  var text_default = simpleTextType("text", "Text", "text");

  // themes/baselayer/src/js/admin/field-builder/types/textarea.js
  function mark2(input, key) {
    input.dataset.blFb = key;
    return input;
  }
  ...
  // themes/baselayer/src/js/admin/field-builder/types/select.js
  function mark3(input, key) {
    input.dataset.blFb = key;
    return input;
  }
  ...
  var select_default = {
    ...
    renderOptions(container) {
      ...
      const allowMultiple = mark3(el("input", { type: "checkbox" }), "allow_multiple");
      container.appendChild(
  ...
  // themes/baselayer/src/js/admin/field-builder/types/checkbox.js
  function mark4(input, key) {
    input.dataset.blFb = key;
    return input;
  }
  ...
  // themes/baselayer/src/js/admin/field-builder/types/email.js
  function mark5(input, key) {
    input.dataset.blFb = key;
    return input;
  }
  var email_default = {
  ...
  // themes/baselayer/src/js/admin/field-builder/types/url.js
  function mark6(input, key) {
    input.dataset.blFb = key;
    return input;
  }
  var url_default = {
  ...
  // themes/baselayer/src/js/admin/field-builder/types/number.js
  function mark7(input, key) {
    input.dataset.blFb = key;
    return input;
  }
  var number_default = {
  ...
  // themes/baselayer/src/js/admin/field-builder/types/phone.js
  function mark8(input, key) {
    input.dataset.blFb = key;
    return input;
  }
  var phone_default = {
  ...
  // themes/baselayer/src/js/admin/field-builder/types/index.js
  var allTypes = [text_default, textarea_default, number_default, email_default, phone_default, url_default, select_default, checkbox_default];
  function registerAllTypes() {
    allTypes.forEach((type) => registerType(type));
  }

  // themes/baselayer/src/js/admin/field-builder/config.js
  var defaultTypeId = "text";

  // themes/baselayer/src/js/admin/field-builder/presentation.js
  var WIDTH_OPTIONS = ["25", "50", "75", "100", "custom"];
  function mark9(input, key) {
    input.dataset.blFb = key;
    return input;
  }
  function renderPresentation(container, data = {}) {
    const presentation = data.presentation && typeof data.presentation === "object" ? data.presentation : {};
    const width = WIDTH_OPTIONS.includes(String(presentation.width || "")) ? String(presentation.width) : "100";
    const widthSelect = mark9(el("select", { className: "widefat" }), "presentation_width");
    [
      ["25", "25%"],
      ["50", "50%"],
      ["75", "75%"],
      ...
      widthSelect.appendChild(
        el("option", {
          value,
          text: label,
          selected: value === width ? true : void 0
        })
      );
    });
    const customWrap = el("div", {
      className: "bl-field-builder__width-custom-wrap",
      hidden: width !== "custom" ? true : void 0
    });
    const customInput = mark9(
      el("input", {
        type: "text",
        className: "widefat",
  ...
  function serializePresentation(fieldRoot) {
  ...
  // themes/baselayer/src/js/admin/field-builder/controls.js
  function createSwitch({ label, checked = false, datasetKey = "", onChange = null } = {}) {
    const inputAttrs = {
      type: "checkbox",
  ...
  function createSegmented(options, active, onSelect, datasetKey = "") {
    const group = el("div", {
  ...
  function openModal({ title = "", body = null, footer = null, onClose = null } = {}) {
    const close = () => {
      overlay.remove();
    ...
    const dialog = el("div", { className: "bl-field-builder__modal-dialog", role: "dialog", "aria-modal": "true" }, [
      ...
      footer ? el("div", { className: "bl-field-builder__modal-footer" }, Array.isArray(footer) ? footer : [footer]) : null
    ]);
  ...
  // themes/baselayer/src/js/admin/field-builder/icons.js
  var ICONS = {
  ...
  function iconEl(key, className = "bl-field-builder__icon") {
    const wrap = el("span", {
      className,
      "aria-hidden": "true"
    });
  ...
  // themes/baselayer/src/js/admin/field-builder/list-row.js
  ...
  function createListRow({
    ...
    const root = el("div", {
      className: "bl-field-builder__item" + (open ? " is-open" : "") + (className ? " " + className : "")
    });
  ...
  // themes/baselayer/src/js/admin/field-builder/field-row.js
    ...
    listTypesForMode(mode).forEach((type) => {
      select.appendChild(
        el("option", {
          ...
          selected: type.id === selected ? true : void 0
        })
      );
    });
  ...
  function createFieldRow({
    ...
    const typeId = requested && allowed.some((type) => type.id === requested) ? requested : fallbackType;
    ...
    if (showTabNav) {
      ...
      tabIds.forEach((id, index2) => {
        tabsNav.appendChild(
          el("button", {
            type: "button",
            className: "bl-field-builder__tab" + (index2 === 0 ? " is-active" : ""),
            role: "tab",
            dataset: { blFbTab: id },
  ...
  function serializeFieldRow(fieldRoot) {
  ...
  // themes/baselayer/src/js/admin/field-builder/sortable.js
  function createSortable(listEl, options = {}) {
    return sortable_esm_default.create(listEl, {
  ...
  // themes/baselayer/src/js/admin/field-builder/shell.js
  function createShell(root, options = {}) {
    ...
    return {
      getSchema() {
        return Array.from(list.querySelectorAll(":scope > [data-bl-fb-field]")).map(
          (row) => serializeFieldRow(row)
        );
      },
      setSchema(fields) {
        empty(list);
  ...
  // themes/baselayer/src/js/admin/field-builder/options-stack.js
  function mountOptionsStack(root, options = {}) {
    ...
    return {
      getStack() {
        return Array.from(list.children).filter((row) => row.classList.contains("bl-options-stack__item")).map((row) => {
  ...
  // themes/baselayer/src/js/admin/field-builder/admin-pages.js
  function bootBlocksAdmin() {
    ...
    const fieldsApi = mount2(fieldsRoot, {
      mode: "fields",
...
sortablejs/modular/sortable.esm.js:
   ...
   *)
*/
//# sourceMappingURL=field-builder-admin.js.map
