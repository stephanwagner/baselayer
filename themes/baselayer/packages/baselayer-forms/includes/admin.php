	...
	if ($is_form_edit && bl_forms_user_can_manage()) {
		...
		wp_localize_script('bl-forms-admin', 'blFormsAdmin', [
			...
			'i18n' => [
				...
				'buttonClassPlaceholder' => __('e.g. -outline or -small', 'baselayer-forms'),
				'buttonClassHelp'   => __('Extra CSS classes on each option button (space-separated), e.g. -outline or -small.', 'baselayer-forms'),
