...
function bl_blocks_enqueue_definition_editor(string $hook): void
{
	...
	$i18n = [
		...
		'settingsInnerBlocksAllowedHelp' => __('Comma-separated block names (e.g. core/heading, core/paragraph). Leave empty to allow all blocks.', 'baselayer-blocks'),
		'settingsInnerBlocksTemplate' => __('Default nested template', 'baselayer-blocks'),
		'settingsInnerBlocksTemplateHelp' => __('Optional JSON array of [blockName, attributes] pairs, e.g. [["core/paragraph",{}]]. Leave empty for no default.', 'baselayer-blocks'),
		'settingsParent'           => __('Parent blocks', 'baselayer-blocks'),
		'settingsParentHelp'       => __('Comma-separated block names this block may be inserted into (e.g. baselayer/slider). Leave empty for top-level.', 'baselayer-blocks'),
