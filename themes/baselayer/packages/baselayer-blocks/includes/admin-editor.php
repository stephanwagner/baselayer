...
function bl_blocks_enqueue_definition_editor(string $hook): void
{
	...
	$type_labels = [
		...
		'range'        => __('Value range', 'baselayer-blocks'),
	...
	$i18n = [
		...
		'settingsInnerBlocksAllowedHelp' => __('Comma-separated block names (e.g. core/heading, core/paragraph). Used when generating the starter template; you can also set allowedBlocks on the InnerBlocks tag in the PHP file. Leave empty to allow all blocks.', 'baselayer-blocks'),
		'settingsInnerBlocksTemplate' => __('Default nested template', 'baselayer-blocks'),
		'settingsInnerBlocksTemplateHelp' => __('Optional JSON array of [blockName, attributes] pairs for the starter template, e.g. [["core/paragraph",{}]]. Prefer the template attribute on the InnerBlocks tag in PHP for the live block. Leave empty for no default.', 'baselayer-blocks'),
		'settingsParent'           => __('Parent blocks', 'baselayer-blocks'),
		'settingsParentHelp'       => __('Comma-separated block names this block may be inserted into (e.g. baselayer/slider). Registration only — not part of the PHP markup. Leave empty for top-level.', 'baselayer-blocks'),
		'settingsAlign'            => __('Alignment supports', 'baselayer-blocks'),
		'settingsAlignHelp'        => __('Select which alignments this block offers in the editor. Leave none selected for no alignment options.', 'baselayer-blocks'),
		'settingsAlignLeft'        => __('Left', 'baselayer-blocks'),
		'settingsAlignCenter'      => __('Center', 'baselayer-blocks'),
		'settingsAlignRight'       => __('Right', 'baselayer-blocks'),
		'settingsAlignWide'        => __('Wide (alignwide)', 'baselayer-blocks'),
		'settingsAlignFull'        => __('Full (alignfull)', 'baselayer-blocks'),
		...
		'stepValue'               => __('Step', 'baselayer-blocks'),
		'rangeDefaultFrom'        => __('Default from', 'baselayer-blocks'),
		'rangeDefaultTo'          => __('Default to', 'baselayer-blocks'),
		...
		'selectAllowNull'         => __('Allow empty selection', 'baselayer-blocks'),
		'selectEmptyOptionLabel'  => __('Empty option label', 'baselayer-blocks'),
		'selectEmptyOptionHelp'   => __('Label for the blank choice. Leave empty for “Please select…”. Required still shows this option, but the user must pick a real value.', 'baselayer-blocks'),
