(() => {
  // themes/baselayer/src/js/admin/form-builder/dom.js
  ...
  function flattenFields(fields = []) {
    ...
    const walk = (list) => {
      (list || []).forEach((field) => {
        if (!field) return;
        if (field.type === "column" || field.type === "section" || field.type === "tab" || field.type === "group") {
          walk(field.children || []);
          return;
        }
        out.push(field);
  ...
  // themes/baselayer/src/js/admin/form-builder/conditional-logic.js
  ...
  // themes/baselayer/src/js/admin/form-builder/layout.js
  var NESTED_BLOCKED = ["column", "section", "tab", "hidden", "honeypot", "captcha"];
  var columnFieldByEl = /* @__PURE__ */ new WeakMap();
  var sectionFieldByEl = /* @__PURE__ */ new WeakMap();
  var tabFieldByEl = /* @__PURE__ */ new WeakMap();
  ...
  function createTabCard(initial = {}) {
    let field = {
      label: "",
      children: [],
      width: "100",
  ...
  function openFieldWidthModal(field, onApply) {
    ...
    const title = field.type === "column" ? t("columnWidthTitle", "Column width") : field.type === "section" ? t("sectionWidthTitle", "Section width") : field.type === "tab" ? t("tabWidthTitle", "Tab width") : t("width", "Width");
  ...
  // themes/baselayer/src/js/admin/form-builder/index.js
  var BlFormBuilder = {
    formsDragStart,
    formsDragEnd,
    TYPE_KEYS,
...
//# sourceMappingURL=form-builder-admin.js.map
