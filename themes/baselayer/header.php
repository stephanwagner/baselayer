...
<head>
	<?php wp_head(); ?>
	<?php function_exists('bl_output_custom_css') && bl_output_custom_css(); ?>
</head>
				...
				<div class="header__aligner container-wide">
					...
					<div class="logo__container">
						<a href="<?= esc_url(home_url('/')) ?>">
							...
							if (!$logo_url) {
								$logo_url = bl_asset_url('/img/logo.svg');
							}
							?>
					...
					<div class="main-menu__wrapper">
						<?php bl_nav_menu([
							...
							'container_aria_label' => esc_attr__('Main navigation', 'baselayer'),
						]); ?>
					</div>

					<?= function_exists('bl_language_switcher_html') ? bl_language_switcher_html() : '' ?>

					<button
						type="button"
						class="header-search__toggle"
						data-modal="search"
						aria-label="<?= esc_attr__('Open search', 'baselayer') ?>">
