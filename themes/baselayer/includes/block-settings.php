...
function bl_block_settings_admin_config(): array
{
	...
	return [
		...
		'i18n'                => [
			...
			'actionAllow'             => __('Allow in inserter', 'baselayer'),
			'actionDisallow'          => __('Disallow from inserter', 'baselayer'),
			'actionHide'              => __('Hide', 'baselayer'),
			'actionShow'              => __('Show', 'baselayer'),
			'actionFavorite'          => __('Add to favorites', 'baselayer'),
			'actionUnfavorite'        => __('Remove from favorites', 'baselayer'),
