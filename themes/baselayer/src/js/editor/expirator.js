(function () {
  ...
  if (!wp || typeof baselayerFeatures === 'undefined' || !baselayerFeatures.post_expirator) {
    return;
  }
  ...
  function ExpiratorPanelContent() {
    ...
    const closeLabel = labels.closeLabel || (wp.i18n && wp.i18n.__ ? wp.i18n.__('Close', 'baselayer') : 'Close');
    ...
    function renderActionDropdownBody(onClose) {
      ...
      return el(
        ...
        el(
          ...
          {
            className:
              'baselayer-expirator__popover-body baselayer-expirator__popover-body--after-expiration baselayer-editor-panel baselayer-expirator-panel baselayer-expirator__dialog',
          },
          el(
            PanelRow,
            null,
    ...
    function renderDropdownBody(onClose) {
      ...
      return el(
        ...
        el(
          ...
          {
            className:
              'baselayer-expirator__popover-body baselayer-expirator__popover-body--expiration-date baselayer-editor-panel baselayer-expirator-panel baselayer-expirator__dialog',
          },
          el(
            PanelRow,
            null,
    ...
    const scheduleLikeRow = el(
      ...
      el(
        ...
        el(Dropdown, {
          ...
          contentClassName:
            'baselayer-expirator__popover-content baselayer-expirator__popover-content--expiration-date editor-post-schedule__dialog',
      ...
      ? el(
          ...
          el(
            ...
            el(Dropdown, {
              ...
              focusOnMount: true,
              className:
                'components-dropdown baselayer-expirator__panel-dropdown baselayer-expirator__action-panel-dropdown editor-post-url__panel-dropdown',
              contentClassName:
                'baselayer-expirator__popover-content baselayer-expirator__popover-content--after-expiration editor-post-url__dialog',
              renderToggle: function (toggleProps) {
                var onToggle = toggleProps.onToggle;
                var isOpen = toggleProps.isOpen;
                return el(
    ...
    return el('div', { className: 'baselayer-expirator-root' }, scheduleLikeRow, afterExpirationRow);
  }
