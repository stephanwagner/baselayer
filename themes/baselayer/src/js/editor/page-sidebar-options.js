(function (wp) {
  ...
  const META_SHOW = '_bl_show_page_title';
  const META_PIN = '_bl_pin_to_dashboard';
  ...
  function PageSidebarOptions(props) {
    ...
    return el(
      'div',
      { className: 'baselayer-page-sidebar-options__inner' },
      el(CheckboxControl, {
  ...
  function PageSidebarOptionsPlugin() {
    ...
    return el(
      ...
      { className: 'baselayer-page-sidebar-options' },
  ...
  registerPlugin('baselayer-page-sidebar-options', {
