...
// window.baselayerIcons.themeCategory from assets/icons.generated.json instead.
const iconL10n = (typeof window !== 'undefined' && window.baselayerIcons) || {};
const runtimeThemeCategory = Object.prototype.hasOwnProperty.call(iconL10n, 'themeCategory')
  ? iconL10n.themeCategory
  : null;
const resolvedThemeCategory =
  runtimeThemeCategory && typeof runtimeThemeCategory === 'object'
    ? runtimeThemeCategory
    : themeIconCategory;

export const iconCategories =
  resolvedThemeCategory &&
  Array.isArray(resolvedThemeCategory.icons) &&
  resolvedThemeCategory.icons.length
    ? [resolvedThemeCategory, ...builtInCategories]
    : builtInCategories;
