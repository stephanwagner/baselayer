	...
	if ($is_form_edit && bl_forms_user_can_manage()) {
		...
		wp_localize_script('bl-forms-admin', 'blFormsAdmin', [
			...
			'i18n' => [
				...
				'tabValidation'     => __('Validation', 'baselayer'),
				...
				'charCountTextHelp' => __('The placeholders %remaining%, %count%, and %max% are replaced by the remaining count, current count, and maximum.', 'baselayer'),
				'charCountSection'  => __('Character count', 'baselayer'),
				...
				'allowMultipleFiles'=> __('Allow multiple files', 'baselayer'),
				'fieldStatus'       => __('Status', 'baselayer'),
				'fieldActive'       => __('Active', 'baselayer'),
				'fieldInactiveTitle'=> __('Not visible on the frontend', 'baselayer'),
				'fieldActivateTitle'=> __('Show on the frontend', 'baselayer'),
				...
				'minMaxMessageHelp' => __('The placeholder %s is replaced by the limit.', 'baselayer'),
				...
				'dateRelationMessageHelp' => __('The placeholder %s is replaced by the related field label.', 'baselayer'),
				...
				'fileTypeError'     => __('Wrong file type', 'baselayer'),
				'fileTypeErrorHelp' => __('The placeholder %s is replaced by the allowed file types.', 'baselayer'),
				'fileSizeError'     => __('File too large', 'baselayer'),
				'fileSizeErrorHelp' => __('The placeholder %s is replaced by the maximum size.', 'baselayer'),
				'fileMaxError'      => __('Too many files', 'baselayer'),
				'fileMaxErrorHelp'  => __('The placeholder %s is replaced by the maximum number of files.', 'baselayer'),
				...
				'maxFiles'          => __('Maximum files', 'baselayer'),
				'maxFilesHelp'      => __('Maximum number of files visitors can upload.', 'baselayer'),
				'showUploadPreview' => __('Show file preview', 'baselayer'),
				'uploadStyle'       => __('Style', 'baselayer'),
				'uploadStyleModern' => __('Modern', 'baselayer'),
				'uploadStyleClassic'=> __('Classic', 'baselayer'),
				'fileSettings'      => __('File settings', 'baselayer'),
				'uploadMaxSize'     => __('Maximum file size', 'baselayer'),
				'uploadMaxSizeUnit' => __('MB', 'baselayer'),
				/* translators: %s: server max upload size, e.g. "64 MB" */
				'uploadMaxSizeHelp' => __('Leave empty to use the server limit (%s).', 'baselayer'),
				'uploadMaxSizeHelpEmpty' => __('Leave empty to use the server limit.', 'baselayer'),
				'afterSubmit'       => __('After submission', 'baselayer'),
				'afterSubmitMessage'=> __('Show success message', 'baselayer'),
