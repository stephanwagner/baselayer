 ...
 * @return void
 */
function bl_clean_up_version(): void
{
	add_filter('admin_footer_text', '__return_empty_string');
	add_filter('update_footer', '__return_empty_string', 11);
}
add_action('init', 'bl_clean_up_version');
 ...
 * @return void
 */
function bl_clean_up_head(): void
{
	// Head
...
add_action('init', 'bl_clean_up_head');
 ...
 * @return void
 */
function bl_clean_up_styles(): void
{
	wp_dequeue_style('classic-theme-styles');
}
add_action('wp_enqueue_scripts', 'bl_clean_up_styles', 100);
 ...
 */
if (!function_exists('bl_config_comments_enabled') || !bl_config_comments_enabled()) {
