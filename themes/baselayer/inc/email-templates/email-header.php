...
<head>
	...
	<style type="text/css">
		...
		.bl-mail-weekly-report-wrapper {
			background: #f1f5f9;
			padding: 32px;
		}

		.bl-mail-weekly-report-content {
			padding: 24px 32px 32px;
		}

		.bl-mail-weekly-report-has-link a {
			color: #2b6cb0;
			text-decoration: none;
			transition: color 280ms;
		}

		.bl-mail-weekly-report-has-link a:hover {
			text-decoration: underline;
			color: #2b6cb0;
		}

		.bl-mail__button:hover {
			text-decoration: none !important;
			color: #fff !important;
			background: #2b6cb0 !important;
		}

		.bl-mail-weekly-report-footer-text a {
			color: #8393A9;
			text-decoration: underline;
			transition: color 280ms;
		}

		.bl-mail-weekly-report-footer-text a:hover {
			color: #2b6cb0;
		}
