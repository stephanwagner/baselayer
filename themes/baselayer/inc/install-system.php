 ...
 */
function bl_htaccess_cleanup_corruption(string $content): string
{
...
function bl_write_htaccess(): bool
{
	...
	$content = bl_htaccess_cleanup_corruption($content);
	$content = bl_remove_htaccess_legacy_performance_block($content);
