	...
	<div class="wrap">
				...
				<table class="form-table" role="presentation">
					<tr>
						...
						<td>
							...
							<p class="description fs-indent-checkbox"><?= esc_html__('Shows a "Duplicate" row action for pages and posts.', 'baselayer') ?></p>
						</td>
					</tr>
				</table>
				...
				<table class="form-table" role="presentation">
					<tr>
						...
						<td>
							...
							<p class="description fs-indent-checkbox"><?= esc_html__('Adds an expiration date to pages and posts.', 'baselayer') ?></p>
						</td>
					</tr>
				</table>
				...
				<table class="form-table" role="presentation">
					<tr>
						...
						<td>
							...
							<p class="description fs-indent-checkbox"><?= esc_html__('Adds a section to pages and posts to enter SEO info.', 'baselayer') ?></p>
						</td>
					</tr>
				</table>
				...
				<table class="form-table" role="presentation">
					<tr>
						...
						<td>
							...
							<p class="description fs-indent-checkbox"><?= esc_html__('Shows breadcrumb navigation on pages, posts, archives, and search.', 'baselayer') ?></p>
							<p class="description fs-indent-checkbox"><?= wp_kses(
								__('Needs <code class="fs-code-small">bl_breadcrumbs()</code> in templates to show.', 'baselayer'),
								['code' => ['class' => true]]
							) ?></p>
						</td>
					</tr>
				...
				<table class="form-table" role="presentation">
					<tr>
						...
						<td>
							...
							<p class="description fs-indent-checkbox"><?= esc_html__('Enables built-in support for multiple content languages.', 'baselayer') ?></p>
							<div id="fs-language-mode-wrap" class="fs-language-mode-wrap" style="margin-top: 12px; <?= $feat('enable_languages') ? '' : 'display:none;' ?>">
								<fieldset>
									...
									<p class="description fs-indent-checkbox" style="margin-top: 0; margin-bottom: 12px;"><?= esc_html__('Separate posts or pages per language with URL prefixes and editor translation panels.', 'baselayer') ?></p>
									...
									<p class="description fs-indent-checkbox" style="margin-top: 0;"><?= esc_html__('Single-language content with automatic on-page translation via Google Translate. Configure languages under Developer → Languages.', 'baselayer') ?></p>
								</fieldset>
							</div>
						</td>
					</tr>
				...
				<table class="form-table" role="presentation">
					<tr>
						...
						<td>
							...
							<p class="description fs-indent-checkbox"><?= esc_html__('Adds folders to the Media Library with a sidebar for organizing.', 'baselayer') ?></p>
						</td>
					</tr>
				</table>
				...
				<table class="form-table" role="presentation">
					<tr>
						...
						<td>
							...
							<p class="description fs-indent-checkbox"><?= esc_html__('Uploaded SVG files are automatically sanitized to remove potentially unsafe code.', 'baselayer') ?></p>
						</td>
					</tr>
				</table>
				...
				<table class="form-table" role="presentation">
					<tr>
						...
						<td>
							...
							<p class="description fs-indent-checkbox"><?= esc_html__('Convert generated JPEG and PNG image to WebP. Requires GD or Imagick with WebP support.', 'baselayer') ?></p>
							<div class="fs-feature-sub" id="fs-feature-sub-webp" style="margin-top: 12px; <?= $feat('enable_webp') !== 1 ? 'display:none;' : '' ?>">
								...
								<p class="description fs-indent-checkbox"><?= esc_html__('By default, only resized versions of an image are converted. The original upload remains unchanged.', 'baselayer') ?></p>
							</div>
						</td>
					</tr>
				</table>
				...
				<table class="form-table" role="presentation">
					<tr>
						...
						<td>
							...
							<p class="description fs-indent-checkbox"><?= esc_html__('Allows blocking specific IP addresses and detects suspicious login attempts.', 'baselayer') ?></p>
						</td>
					</tr>
				</table>
				...
				<table class="form-table" role="presentation">
					<tr>
						<th scope="row" class="form-table-checkbox-label">
							...
							<span class="fs-feature-beta"><?= esc_html__('Beta', 'baselayer') ?></span>
						</th>
						<td>
							...
							<p class="description fs-indent-checkbox"><?= esc_html__('Adds an admin UI to overlay block-option presets and assignments. File config (config/block-options.php) remains the baseline.', 'baselayer') ?></p>
						</td>
					</tr>
				</table>
				...
				<table class="form-table" role="presentation">
					<tr>
						...
						<td>
							...
							<p class="description fs-indent-checkbox"><?= esc_html__('Enables Matomo script loading on the frontend using the settings from Developer › Settings.', 'baselayer') ?></p>
						</td>
					</tr>
				</table>
		...
		<script>
			(function() {
				...
				bindToggle('baselayer_features_enable_webp', 'fs-feature-sub-webp');
			})();
		</script>
	</div>
<?php
